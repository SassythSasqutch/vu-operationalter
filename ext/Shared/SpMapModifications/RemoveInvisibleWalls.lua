...
-- Temp fix: nuke HighwayOfDeath StaticGroupModelEntityData (it doesn't contain much other than invisible walls anyway - a couple rocks and backdrop telephone poles)
